...
export const statuses: Record<string,string> = {open:'Aberta',diagnosis:'Em diagnóstico',awaiting:'Aguardando aprovação',approved:'Aprovada',rejected:'Recusada',in_progress:'Em execução',completed:'Concluída',delivered:'Entregue',cancelled:'Cancelada'};
export const transitions: Record<string,string[]> = {open:['diagnosis','cancelled'],diagnosis:['awaiting','cancelled'],awaiting:['diagnosis','cancelled'],approved:['in_progress','cancelled'],rejected:['diagnosis','cancelled'],in_progress:['completed','cancelled'],completed:['delivered','cancelled'],delivered:[],cancelled:[]};
