...
def email_content(company, client, order, link='', custom_text=None):
    ...
    logo_url = escape(company.get('email_logo_url') or os.environ.get('EMAIL_LOGO_URL') or 'https://res.cloudinary.com/ditlmzgrh/image/upload/v1789756511/ChatGPT_Image_18_de_set._de_2026_15_33_29_uutxrq.png', quote=True)
